...
| [02](02-renderdoc-debug-events/README.md) | RenderDoc debug event/marker/label | 구현 대기 |
...
| --- | --- | --- | --- | --- |
| Tracy CPU zones | 빌드 대기 | 빌드·실행 완료 | 빌드·실행 대기 | 빌드·실행 대기 |
| Debug events | 대기 | 대기 | 대기 | 대기 |
